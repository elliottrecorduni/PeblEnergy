                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="card-header bg-dark text-white">
                                Active Devices
                                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#new_device_modal" style="float:right">New Device</button>
                                <div class="modal fade" id="new_device_modal" tabindex="-1" role="dialog" aria-labelledby="new_device_modalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-dark" id="new_device_modalLabel">Add New Device</h5>
